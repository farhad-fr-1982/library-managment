...
export const userDashboardPageStyles = {
  ...
  heroTitle: "mt-5 font-display text-2xl font-semibold leading-tight text-library-ink sm:text-3xl sm:leading-none lg:text-4xl",
  ...
  profileName: "wrap-anywhere mt-3 font-display text-xl font-semibold text-library-ink sm:text-2xl",
  ...
  semesterValue: "mt-3 font-display text-xl font-semibold text-library-gold-soft",
  ...
  statValue: "font-numeric mt-2 text-xl font-semibold text-library-ink tabular-nums sm:text-2xl",
  statNote: "mt-2 text-sm text-library-ink/55",
  ...
  recentTitle: "font-display text-xl font-semibold text-library-ink sm:text-2xl",

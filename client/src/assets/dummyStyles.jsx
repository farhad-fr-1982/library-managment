// assets/dummyStyles.js - RTL Version (Smaller Fonts)

export const adminLayoutStyles = {
  layoutContainer: "relative min-h-screen",
  mainContent: "min-h-screen px-4 pb-8 pt-20 md:mr-72.5 md:px-8 md:pt-8",
  innerContainer: "mx-auto max-w-7xl",
};

export const sidebarStyles = {
  mobileMenuButton: "fixed right-4 top-4 z-50 inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-white/20 bg-library-panel text-library-paper shadow-lg md:hidden",
  ...
  sidebar: "fixed right-0 top-0 z-50 flex h-full w-[min(18.5rem,calc(100vw-1rem))] max-w-full flex-col border-l border-white/10 bg-library-panel text-library-paper transition-transform duration-300 md:w-72.5 md:translate-x-0",
  ...
  title: "wrap-anywhere font-display text-xl font-semibold tracking-wide sm:text-2xl",
...
export const loginStyles = {
  ...
  mainCard: "grid w-full max-w-6xl overflow-hidden rounded-[28px] border border-white/60 bg-library-paper/85 shadow-[0_25px_60px_rgba(20,35,29,0.18)] backdrop-blur-[18px] sm:rounded-[36px] lg:grid-cols-[0.95fr_1fr]",
  ...
  infoTitle: "mt-6 font-display text-2xl font-semibold leading-tight text-library-gold-soft sm:text-3xl sm:leading-none lg:text-4xl",
  ...
  formTitle: "mt-4 font-display text-2xl font-semibold text-library-ink sm:text-3xl",
...
export const signupStyles = {
  pageContainer: "relative flex min-h-screen items-center justify-center px-4 py-6 sm:py-10",
  toastBase: "fixed right-4 top-4 z-80 rounded-[22px] border px-4 py-4 text-sm font-semibold shadow-2xl transition-all duration-300 sm:right-5 sm:top-5 sm:px-5",
  ...
  mainCard: "grid w-full max-w-6xl overflow-hidden rounded-[28px] border border-white/60 bg-library-paper/85 shadow-[0_25px_60px_rgba(20,35,29,0.18)] backdrop-blur-[18px] sm:rounded-[36px] lg:grid-cols-[1fr_0.96fr]",
  formPanel: "p-5 sm:p-8 lg:p-10",
  formInner: "mx-auto max-w-md",
  backLink: "text-sm font-semibold text-library-ink/62",
  panelTitle: "mt-4 font-display text-2xl font-semibold text-library-ink sm:text-3xl",
...
export const homeStyles = {
  ...
  heroGrid: "grid gap-8 xl:grid-cols-[0.9fr_1.25fr] xl:items-center",
  ...
  heroTitle: "mt-6 max-w-3xl font-display text-2xl font-semibold leading-tight text-library-ink sm:text-3xl sm:leading-none lg:text-4xl xl:text-5xl",
  ...
  infoCardTitle: "mt-4 font-display text-xl font-semibold text-library-gold-soft sm:text-2xl",
  ...
  featureTitle: "mt-5 font-display text-lg font-semibold text-library-ink sm:text-xl",
  featureText: "mt-3 text-sm leading-7 text-library-ink/68",
};

export const userLayoutStyles = {
  layoutContainer: "relative min-h-screen",
  mainContent: "min-h-screen px-4 pb-8 pt-20 md:mr-72.5 md:px-6 md:pt-8 lg:px-8",
  innerContainer: "mx-auto max-w-375",
};

export const adminDashboardStyles = {
  container: "space-y-8",
  heroSection: "rounded-[26px] border border-white/65 bg-library-panel p-5 text-library-paper shadow-[0_25px_60px_rgba(20,35,29,0.18)] backdrop-blur-[18px] sm:rounded-[30px] sm:p-6 lg:rounded-[34px] lg:p-8",
  heroInner: "grid gap-6 xl:grid-cols-[0.95fr_1.25fr] xl:items-end",
  ...
  heading: "mt-5 font-display text-lg font-semibold leading-tight text-library-gold-soft sm:text-xl sm:leading-none lg:text-2xl",
  heroParagraph: "mt-4 max-w-2xl text-sm leading-7 text-library-paper/72",
  statsGrid: "grid gap-4 sm:grid-cols-2 xl:grid-cols-4",
  statCard: "rounded-[28px] border border-white/70 bg-white/72 p-5 shadow-[0_25px_60px_rgba(20,35,29,0.18)] backdrop-blur-[18px]",
  statIcon: "inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-library-panel text-library-paper",
  statLabel: "mt-5 text-sm font-medium text-library-ink/62",
  statValue: "[font-family:var(--font-numeric)] mt-2 text-xl font-semibold text-library-ink tabular-nums sm:text-2xl",
  statNote: "mt-2 text-sm text-library-ink/55",
  overdueSection: "rounded-[26px] border border-white/70 bg-white/74 p-5 shadow-[0_25px_60px_rgba(20,35,29,0.18)] backdrop-blur-[18px] sm:rounded-[30px] sm:p-6",
  overdueHeader: "flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between",
  overdueTitle: "font-display text-lg font-semibold text-library-ink sm:text-xl",
  ...
  mostFineBadge: "inline-flex rounded-full bg-rose-100 px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-rose-900",
  ...
  studentFine: "mt-2 font-display text-xl font-semibold text-library-ink",
  highestFineBookContainer: "rounded-2xl bg-white/80 px-4 py-3 text-right sm:text-left",
  ...
  emptyState: "rounded-3xl border border-library-ink/10 bg-library-paper/70 px-5 py-8 text-center text-library-ink/65 xl:col-span-2",
  viewMoreContainer: "mt-6 flex justify-start",
  viewMoreLink: "inline-flex items-center gap-2 rounded-2xl bg-library-paper/70 px-4 py-3 text-sm font-semibold transition hover:opacity-90",
};

export const adminFinesPageStyles = {
  pageContainer: "space-y-6",
  toastWrapper: "fixed right-4 top-4 z-80 rounded-[22px] border border-emerald-200 bg-white px-4 py-4 text-sm font-semibold text-emerald-900 shadow-2xl transition-all duration-300 sm:right-5 sm:top-5 sm:px-5",
  toastContent: "flex items-center gap-3",
  ...
  title: "font-display text-xl font-semibold text-library-ink sm:text-2xl",
  ...
  formContainer: "mt-6 grid gap-4 rounded-3xl border border-library-ink/10 bg-library-paper/70 p-4 sm:p-5 lg:grid-cols-[auto_1fr_0.8fr]",
  label: "block",
...
export const adminUsersPageStyles = {
  ...
  fixedModal: "fixed right-4 top-4 z-90 w-auto max-w-sm rounded-3xl border border-library-ink/10 bg-white px-4 py-4 shadow-2xl transition-all duration-300 sm:right-5 sm:top-5 sm:w-full sm:px-5",
  ...
  toastBase: "fixed right-4 top-4 z-80 rounded-[22px] border bg-white px-4 py-4 text-sm font-semibold shadow-2xl transition-all duration-300 sm:right-5 sm:top-5 sm:px-5",
  ...
  statValue: "[font-family:var(--font-numeric)] mt-2 break-words text-xl font-semibold text-library-ink tabular-nums sm:text-2xl",
  ...
  headerTitle: "font-display text-xl font-semibold leading-tight text-library-ink sm:text-2xl",
...
export const adminBooksPageStyles = {
  ...
  headerFlex: "flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between",
  title: "font-display text-lg font-semibold text-library-ink sm:text-xl",
  ...
  studentRollSpan: "mr-2 text-library-ink/60",
  ...
  booksTitle: "font-display text-base font-semibold text-library-ink sm:text-lg",
...
export const userBooksPageStyles = {
  ...
  heroTitle: "mt-5 font-display text-lg font-semibold leading-tight text-library-ink sm:text-xl",
  ...
  sectionTitle: "font-display text-lg font-semibold text-library-ink sm:text-xl",
...
export const userDashboardPageStyles = {
  ...
  heroGrid: "grid gap-6 xl:grid-cols-[0.8fr_1.2fr] xl:items-end",
  heroLeft: "max-w-3xl",
  heroBadge: "inline-flex items-center gap-2 rounded-full bg-library-panel px-3 py-1.5 text-[0.55rem] font-bold uppercase tracking-[0.18em] text-library-paper sm:px-4 sm:text-[0.65rem] sm:tracking-[0.28em]",
  heroTitle: "mt-5 font-display text-lg font-semibold leading-tight text-library-ink sm:text-xl sm:leading-none lg:text-2xl",
  heroText: "mt-4 max-w-2xl text-xs leading-7 text-library-ink/68 sm:text-sm",
  ...
  profileLabel: "text-[0.65rem] font-bold uppercase tracking-[0.24em] text-library-ink/45",
  profileName: "wrap-anywhere mt-3 font-display text-lg font-semibold text-library-ink sm:text-xl",
  profileIconWrapper: "inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-library-paper text-library-panel",
  profileDetails: "mt-5 grid gap-3 text-xs text-library-ink/72",
  ...
  semesterLabel: "text-[0.65rem] font-bold uppercase tracking-[0.24em] text-library-paper/55",
  semesterValue: "mt-3 font-display text-lg font-semibold text-library-gold-soft",
  semesterIconWrapper: "inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10 text-library-gold-soft",
  semesterDetails: "mt-5 grid gap-3 text-xs text-library-paper/78",
  ...
  statLiveBadge: "rounded-full bg-library-paper px-3 py-1 text-[0.65rem] font-semibold text-library-ink/60",
  statLabel: "mt-5 text-xs font-medium text-library-ink/65",
  statValue: "font-numeric mt-2 text-lg font-semibold text-library-ink tabular-nums sm:text-xl",
  statNote: "mt-2 text-xs text-library-ink/55",
  ...
  recentTitle: "font-display text-lg font-semibold text-library-ink sm:text-xl",
  recentSubtitle: "mt-2 max-w-2xl text-xs leading-7 text-library-ink/60",
  viewMoreButton: "inline-flex w-fit items-center justify-center rounded-full bg-library-paper/82 px-5 py-2.5 text-xs font-semibold transition",
...
export const userBookCardStyles = {
  ...
  title: "wrap-anywhere font-display text-xl font-semibold leading-tight text-library-ink sm:text-2xl",
